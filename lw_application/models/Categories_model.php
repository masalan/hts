...
class Categories_Model extends CI_Model
{
    ...
    */  
    ...
    {
        $this ->db ->query("INSERT INTO categories(name) VALUES(?)", array($this ->input ->post('nom', true)));
    }

    public function get($id)
    {
        return $this ->db ->query("SELECT * FROM categories WHERE id = ?", array($id));
    }

    public function get_catg_pdts($id)
    {
        return $this ->db ->query("SELECT * FROM products WHERE category = ?", array($id)) ->result();
    }
    
    public function update($id)
    {
        $this ->db ->query("UPDATE categories SET name = ? WHERE id = ?", array($this ->input ->post('nom', true), $id));
    }
}
