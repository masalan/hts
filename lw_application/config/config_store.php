...
$config['apply_theme']					= envItem('DEFAULT_THEME', 'bootstrap3');
/*If you set it as true, system will use paypal sandbox site for testing purpuses*/
$config['paypal_testing']				= envItem('PAYPAL_TESTING', false);
...
$config['show_lively_cart_credit']	= envItem('LIVELYCART_CREDIT', true);;